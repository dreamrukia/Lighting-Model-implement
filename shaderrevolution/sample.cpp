...
public:
	...
	Scene() :
		...
		texture("test.jpg"),
		shader("myShader1.vert", "myShader1.frag", NULL),
		shader2("myShader2.vert","myShader2.frag",NULL),
		...
		, useTexture("Environment Map", false),
		...
		useShader("My Shader #1", false),
		useShader2("My Shader #2", false),
